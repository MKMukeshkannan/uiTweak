...
function Signup() {
  ...
  return (
    <>
      <main className="flex flex-col items-center justify-center h-screen px-36 pt-10 pb-24">
        <h1 className="text-7xl font-black tracking-normal mb-12 text-[#077B79]">
          <Link href="/">uiTweak</Link>
        </h1>
        <section className="flex flex-row h-full w-full shadow-2xl">
          <section className="pt-16 text-center bg-white bg-opacity-50 backdrop-filter backdrop-blur-3xl h-full w-1/2">
            <h1 className="text-5xl font-black tracking-normal text-[#077B79]">
              SIGN UP
            </h1>
            <form
              onSubmit={handleSubmit(onSubmit)}
              className="flex flex-col items-center justify-center px-32"
            >
              <input
                type="text"
                {...register("name", {
              ...
              <input
                ...
                className="mb-1 w-full h-12 px-5 text-xl text-[#077B79] font-medium  focus:outline-[#077B79] border border-solid border-gray-200 shadow-md"
                placeholder="EMAIL"
              />
              <p className="mb-3 pl-3 text-red-400 self-start text-sm">
            ...
            <p className="text-[#7CA8A1] text-md px-28 mt-5">
              ALREADY HAVE AN ACCOUNT ?
              <button className="hover:text-[#077b79] hover:shadow-md">
                LOGIN
              </button>
            </p>
          </section>
          <section className="relative bg-[#077B79] h-full w-1/2">
            <svg
              ...
              className="relative top-12 right-20 w-[100%]"
            >
              <polygon
