  ...
  return (
    <>
      <main className="flex flex-col items-center justify-center h-screen px-36 pt-10 pb-24 2xl:px-72 2xl:py-36 max-sm:px-3">
        <h1 className="text-7xl font-black tracking-normal mb-12 text-[#077B79] 2xl:text-9xl">
        ...
        <section className="flex flex-row h-full w-full shadow-2xl">
          ...
          <section className="relative bg-[#077B79] h-full w-1/2 max-sm:hidden max-md:hidden">
            <svg
              ...
              className="absolute bottom-0 right-20 w-[100%] 2xl:h-[100%] 2xl:top-0 lg:right-0"
            >
              <polygon
